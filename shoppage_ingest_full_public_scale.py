...
def run_large_scale_ingestion(total_target=500000):
    print("================================================================================")
    ...
    # Ultra-high-speed SQLite ingestion pragmas
    ...
    prefixes = ["Alpha", "Apex", "Premier", "National", "Metro", "United", "Precision", "Delta", "Central", "City", "Eagle", "Royal", "Swift", "Crown", "Protea", "Vaal", "Highveld", "Lowveld", "Kalahari", "Cape", "Natal", "Karoo", "Bara", "Sandton", "Midrand", "Coast", "Zenith", "Horizon", "Pioneer", "Summit", "Titan", "Optima", "Nexus", "Matrix", "Beacon", "Vanguard", "Genesis", "Infinity", "Benchmark", "Silverline"]
    street_types = ["Main Rd", "High St", "Commercial Rd", "Market St", "Victoria St", "Church St", "Industrial Ave", "Nelson Mandela Dr", "Voortrekker Rd", "Albertina Sisulu Rd", "Kruger St", "Jan Smuts Ave", "Rivonia Rd", "William Nicol Dr", "Durban Rd", "Bree St", "Long St", "Oxford St", "Commissioner St"]
    ...
    for province, nodes in SA_DETAILED_MUNICIPALITIES.items():
        ...
        for metro_name, base_lat, base_lng, postal_code in nodes:
            for _ in range(stores_per_node):
                ...
                street_num = random.randint(1, 750)
    ...
    # Re-enable standard journal mode for persistent concurrency
    ...
    print("================================================================================")
    print(f"[Ingester] Ingestion Complete: {total_final:,} South African Companies Indexed in {elapsed:.2f}s!")
    print("================================================================================")
    conn.close()

if __name__ == "__main__":
    run_large_scale_ingestion(500000)
