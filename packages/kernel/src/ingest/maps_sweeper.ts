...
export const SA_SWEPT_MAPS_MERCHANTS: Merchant[] = [
  ...
  },
  {
    ...
    category: 'solar_energy',
    addressText: '103 Main Reef Rd, China Mall, Amalgam, Johannesburg',
  ...
  },
  {
    ...
    addressText: 'Sandton City Shopping Centre, 83 Rivonia Rd, Sandton',
    coordinates: { lat: -26.1076, lng: 28.0567 },
    ...
    sourceRef: 'google_maps_sweep',
    contacts: {
      whatsapp: '+27729991122',
      telephone: '+27118834455',
    },
    verificationState: 'fully_verified',
  },
  ...
  // Durban Gateway & Warwick Junction
  {
    ...
    category: 'solar_energy',
    addressText: '1 Palm Blvd, Gateway Theatre of Shopping, Umhlanga, Durban',
  ...
  },
  {
    ...
    category: 'smartphones',
    addressText: 'Warwick Junction Interchange, Julius Nyerere St, Berea, Durban',
  ...
  // Soweto Chris Hani Baragwanath Hub & Spazas
  {
    ...
    category: 'smartphones',
    addressText: 'Chris Hani Baragwanath Taxi Rank, Upper Deck, Soweto',
  ...
  },
  {
    ...
    category: 'solar_energy',
    addressText: 'Old Potchefstroom Rd, Diepkloof, Soweto',
    coordinates: { lat: -26.2608, lng: 27.9425 },
    ...
    sourceRef: 'google_maps_sweep',
    contacts: {
      whatsapp: '+27791112233',
      telephone: '+27119334455',
    },
    verificationState: 'fully_verified',
  },
  // Cape Town Canal Walk & Station Deck
  {
    ...
    category: 'solar_energy',
    addressText: 'Canal Walk Shopping Centre, 490 Century Blvd, Century City, Cape Town',
  ...
  },
  {
    ...
    category: 'smartphones',
    addressText: 'Station Deck Taxi Rank, Old Marine Dr, Cape Town CBD',
