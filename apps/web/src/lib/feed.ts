...
export function getFeed(): FeedPost[] {
  ...
  // Insert real community poll into feed
  const pollPost: FeedPost = {
    id: 'poll_loadshedding_stage6',
    kind: 'demand',
    author: {
      id: 'loadsheddingza',
    ...
    stats: { replies: 312, reposts: 187, likes: 2410, saves: 512 },
    cta: { label: 'Explore Solar Deals', href: '/search?q=solar' },
  };
  blended.splice(3, 0, pollPost);
