  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '1.25rem' }}>
        ...
        <div style={{ background: 'var(--color-surface)', borderRadius: '16px', border: '1px solid var(--color-line)', padding: '1.5rem', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ fontSize: '1.4rem' }}>🏛️</span>
              <div>
                <h3 style={{ fontSize: '0.95rem', fontWeight: 800, color: 'var(--color-content)', margin: 0 }}>CIPC Enterprise Verification</h3>
                <div style={{ fontSize: '0.72rem', color: 'var(--color-content-muted)' }}>Companies and Intellectual Property Commission</div>
              </div>
            </div>
            <span style={{ fontSize: '0.68rem', fontWeight: 800, color: 'var(--color-brand-700)', background: 'var(--color-brand-100)', padding: '2px 8px', borderRadius: '4px' }}>
              ✓ ACTIVE IN GOOD STANDING
            </span>
          </div>

          <div style={{ marginTop: '1rem', display: 'flex', flexDirection: 'column', gap: '0.4rem', fontSize: '0.8rem', color: 'var(--color-content-secondary)' }}>
        ...
        <div style={{ background: 'var(--color-surface)', borderRadius: '16px', border: '1px solid var(--color-line)', padding: '1.5rem', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <div>
                <h3 style={{ fontSize: '0.95rem', fontWeight: 800, color: 'var(--color-content)', margin: 0 }}>SARS Tax Compliance Status</h3>
                <div style={{ fontSize: '0.72rem', color: 'var(--color-content-muted)' }}>South African Revenue Service</div>
              </div>
            </div>
            <span style={{ fontSize: '0.68rem', fontWeight: 800, color: 'var(--color-brand-700)', background: 'var(--color-brand-100)', padding: '2px 8px', borderRadius: '4px' }}>
        ...
        <div style={{ background: 'var(--color-surface)', borderRadius: '16px', border: '1px solid var(--color-line)', padding: '1.5rem', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ fontSize: '1.4rem' }}>⚡</span>
              <div>
                <h3 style={{ fontSize: '0.95rem', fontWeight: 800, color: 'var(--color-content)', margin: 0 }}>SABS & NRS 097 Compliance</h3>
                <div style={{ fontSize: '0.72rem', color: 'var(--color-content-muted)' }}>South African Bureau of Standards</div>
              </div>
            </div>
            <span style={{ fontSize: '0.68rem', fontWeight: 800, color: 'var(--color-brand-800)', background: 'var(--color-brand-100)', padding: '2px 8px', borderRadius: '4px' }}>
        ...
        <div style={{ background: 'var(--color-surface)', borderRadius: '16px', border: '1px solid var(--color-line)', padding: '1.5rem', boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ fontSize: '1.4rem' }}>🏬</span>
              <div>
                <h3 style={{ fontSize: '0.95rem', fontWeight: 800, color: 'var(--color-content)', margin: 0 }}>Physical Storefront Audit</h3>
                <div style={{ fontSize: '0.72rem', color: 'var(--color-content-muted)' }}>Geofenced Trading Precinct</div>
              </div>
            </div>
            <span style={{ fontSize: '0.68rem', fontWeight: 800, color: 'var(--color-brand-700)', background: 'var(--color-brand-100)', padding: '2px 8px', borderRadius: '4px' }}>
              ✓ AUDITED ON-SITE
      ...
      <div style={{ background: 'var(--color-surface)', borderRadius: '16px', border: '1px solid var(--color-line)', padding: '1.5rem' }}>
        ...
        <div style={{ background: 'var(--color-surface-subtle)', padding: '0.85rem 1rem', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '1rem' }}>
          <code style={{ fontSize: '0.75rem', color: 'var(--color-content-secondary)', wordBreak: 'break-all' }}>
            {sealSnippet}
          </code>
          <button
            onClick={copySeal}
