...
func CorporateFooter() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		ctx = templ.ClearChildren(ctx)
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 65, "<footer class=\"w-full bg-slate-900 text-slate-300 border-t border-slate-800 mt-12 py-12 px-4 sm:px-6 lg:px-8 select-none\" style=\"background-color: #090d16; border-top: 1px solid #1e293b;\"><div class=\"max-w-7xl mx-auto space-y-10\"><!-- Top Row: Enterprise Vetting & Compliance Bar --><div class=\"p-6 rounded-2xl bg-slate-950/80 border border-slate-800 flex flex-col md:flex-row items-center justify-between gap-6\" style=\"background: rgba(15, 23, 42, 0.6); border: 1px solid rgba(51, 65, 85, 0.5);\"><div class=\"flex items-center gap-4\"><div class=\"w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 flex items-center justify-center text-2xl shrink-0\">🛡️</div><div><h4 class=\"text-sm font-black text-white flex items-center gap-2\"><span>Shoppage Enterprise Vetting Desk</span> <span class=\"px-2 py-0.5 rounded-full bg-emerald-950 text-emerald-400 border border-emerald-800 text-[10px] font-bold\">100% CIPC &amp; SARS Vetted</span></h4><p class=\"text-xs text-slate-400 mt-0.5 max-w-xl\">Every commercial supplier indexed on Shoppage undergoes rigorous enterprise vetting: CIPC registration checks, SARS Tax PIN verification, and physical warehouse / depot authentication.</p></div></div><div class=\"flex items-center gap-3 shrink-0\"><a href=\"/enterprise-vetting\" class=\"px-4 py-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-white text-xs font-bold transition border border-slate-700\">Vetting Standards &amp; Directory</a> <a href=\"/track\" class=\"px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold transition shadow-sm\">Track Order &rarr;</a></div></div><!-- 4 Columns of Corporate Navigation --><div class=\"grid grid-cols-2 md:grid-cols-4 gap-8 text-xs\"><!-- Col 1: Commercial Marketplace --><div><h5 class=\"text-xs font-black text-white uppercase tracking-wider mb-3.5\">Commercial Marketplace</h5><ul class=\"space-y-2.5 text-slate-400 font-medium\"><li><a href=\"/?tab=products\" class=\"hover:text-emerald-400 transition\">1,000,000+ Master Catalog</a></li><li><a href=\"/?tab=deals\" class=\"hover:text-rose-400 transition\">🔥 National Retailer Specials</a></li><li><a href=\"/?tab=tradewire\" class=\"hover:text-emerald-400 transition\">Live Trade Wire &amp; RFQs</a></li><li><a href=\"/?tab=products&category=solar\" class=\"hover:text-emerald-400 transition\">Solar Inverters &amp; Lithium Batteries</a></li><li><a href=\"/?tab=products&category=packaging\" class=\"hover:text-emerald-400 transition\">Corrugated Cartons &amp; Packaging</a></li><li><a href=\"/search\" class=\"hover:text-emerald-400 transition\">Instant Omnisearch Core</a></li></ul></div><!-- Col 2: For Suppliers & Wholesalers --><div><h5 class=\"text-xs font-black text-white uppercase tracking-wider mb-3.5\">For Suppliers &amp; Wholesalers</h5><ul class=\"space-y-2.5 text-slate-400 font-medium\"><li><a href=\"/sell\" class=\"text-emerald-400 font-bold hover:underline\">Sell on Shoppage (Join as Supplier)</a></li><li><a href=\"/desk\" target=\"_blank\" class=\"hover:text-emerald-400 transition\">Merchant OS Console</a></li><li><a href=\"/sell#verification\" class=\"hover:text-emerald-400 transition\">CIPC Supplier Verification</a></li><li><a href=\"/desk\" target=\"_blank\" class=\"hover:text-emerald-400 transition\">B2B Proforma Invoices &amp; EFT</a></li><li><a href=\"/m/loc_mitrend_midrand\" class=\"hover:text-emerald-400 transition\">Example Live Storefront</a></li><li><a href=\"/sell#pricing\" class=\"hover:text-emerald-400 transition\">Pricing &amp; 3.5% Settlement Fee</a></li></ul></div><!-- Col 3: Enterprise Vetting Desk --><div><h5 class=\"text-xs font-black text-white uppercase tracking-wider mb-3.5\">Enterprise Vetting Desk</h5><ul class=\"space-y-2.5 text-slate-400 font-medium\"><li><a href=\"/enterprise-vetting#cipc\" class=\"hover:text-emerald-400 transition\">CIPC Corporate Registry Vetting</a></li><li><a href=\"/enterprise-vetting#sars\" class=\"hover:text-emerald-400 transition\">SARS Tax PIN &amp; VAT Compliance</a></li><li><a href=\"/enterprise-vetting#depot\" class=\"hover:text-emerald-400 transition\">Physical Depot &amp; Site Inspection</a></li><li><a href=\"/enterprise-vetting#bbbee\" class=\"hover:text-emerald-400 transition\">B-BBEE Procurement Recognition</a></li><li><a href=\"/enterprise-vetting#sabs\" class=\"hover:text-emerald-400 transition\">SABS &amp; Technical Standards</a></li><li><a href=\"/track\" class=\"hover:text-emerald-400 transition\">Freight Tracking (The Courier Guy)</a></li></ul></div><!-- Col 4: Logistics & Partners --><div><h5 class=\"text-xs font-black text-white uppercase tracking-wider mb-3.5\">Logistics &amp; Clearing Partners</h5><div class=\"space-y-3 text-slate-400 font-medium\"><div class=\"flex items-center gap-2\"><span class=\"w-2 h-2 rounded-full bg-emerald-400\"></span> <span>The Courier Guy (Express Freight)</span></div><div class=\"flex items-center gap-2\"><span class=\"w-2 h-2 rounded-full bg-emerald-400\"></span> <span>Pudo Smart Locker Network (24/7)</span></div><div class=\"flex items-center gap-2\"><span class=\"w-2 h-2 rounded-full bg-emerald-400\"></span> <span>Ozow Instant EFT &amp; Capitec Pay</span></div><div class=\"flex items-center gap-2\"><span class=\"w-2 h-2 rounded-full bg-emerald-400\"></span> <span>Visa, Mastercard &amp; South African Banks</span></div><div class=\"pt-2 border-t border-slate-800 text-[11px] text-slate-500\">Direct integration with Gallagher Convention Business Park &amp; Crown Mines trade depots.</div></div></div></div><!-- Bottom Corporate Copyright & Credentials --><div class=\"pt-8 border-t border-slate-800/80 flex flex-col md:flex-row items-center justify-between gap-4 text-[11px] text-slate-500\"><div class=\"flex items-center gap-3\"><div class=\"flex items-center gap-1.5 font-bold text-slate-300\"><span class=\"text-emerald-400 text-sm\">⚡</span> <span>SHOPPAGE SOUTH AFRICA</span></div><span>•</span> <span>Shoppage Technologies South Africa (Pty) Ltd · Reg: 2024/098412/07 · VAT: 4920194821</span></div><div class=\"flex items-center gap-4\"><span>Headquarters: The Pivot, Montecasino Blvd, Fourways, Johannesburg, 2055</span> <span>🇿🇦 Proudly South African</span></div></div></div></footer>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
