...
func DiscountsTab(data models.DashboardViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, tier := range data.WholesaleTiers {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 48, Col: 29}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 49, Col: 107}
			}
			...
			if tier.MaxUnits > 0 {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 52, Col: 88}
				}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 57, Col: 112}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 58, Col: 79}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 73, Col: 110}
		}
		...
		for _, coup := range data.Coupons {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 91, Col: 98}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 92, Col: 78}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 93, Col: 61}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 94, Col: 107}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/discounts.templ`, Line: 103, Col: 68}
			}
