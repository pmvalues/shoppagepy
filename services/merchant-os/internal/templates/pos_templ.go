...
func POSTerminalTab(data models.DashboardViewData) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		for _, item := range data.Catalog {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 40, Col: 35}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 45, Col: 94}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 46, Col: 94}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 49, Col: 127}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 141, Col: 116}
		}
		...
		for _, txn := range data.RecentPOSTxns {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 160, Col: 96}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 161, Col: 89}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 162, Col: 28}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 163, Col: 52}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 164, Col: 96}
			}
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `services/merchant-os/internal/templates/pos.templ`, Line: 165, Col: 119}
			}
